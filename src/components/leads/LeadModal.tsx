            ...
            <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-sm sm:max-w-md">
              ...
              <form onSubmit={handleAddCall} className="space-y-3 sm:space-y-4">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-end gap-2 sm:gap-3">
                  ...
                  <button
                    type="submit"
                    className="px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 order-1 sm:order-2 text-sm sm:text-base"
                  >
                    {isCreatingCall ? <div className="w-6 h-6 sm:w-7 sm:h-7 border-2 border-white border-t-transparent rounded-full animate-spin" role="status"></div> : t('logCallButton')}
                  </button>
                </div>
              </form>
            </div>
